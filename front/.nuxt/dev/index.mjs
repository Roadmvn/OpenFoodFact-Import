import process from 'node:process';globalThis._importMeta_={url:import.meta.url,env:process.env};import { getRequestHeader, splitCookiesString, setResponseStatus, setResponseHeader, send, getRequestHeaders, defineEventHandler, handleCacheHeaders, createEvent, fetchWithEvent, isEvent, eventHandler, setHeaders, sendRedirect, proxyRequest, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getResponseStatus, setResponseHeaders, createError, getRouterParam, readBody, getQuery as getQuery$1, getResponseStatusText } from 'file:///mnt/c/Users/tudyg/projet/T-DEV-703-Mobile/front/node_modules/h3/dist/index.mjs';
import { Server } from 'node:http';
import { mkdirSync } from 'node:fs';
import { tmpdir } from 'node:os';
import { join } from 'node:path';
import { parentPort, threadId } from 'node:worker_threads';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///mnt/c/Users/tudyg/projet/T-DEV-703-Mobile/front/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///mnt/c/Users/tudyg/projet/T-DEV-703-Mobile/front/node_modules/devalue/index.js';
import destr from 'file:///mnt/c/Users/tudyg/projet/T-DEV-703-Mobile/front/node_modules/destr/dist/index.mjs';
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL } from 'file:///mnt/c/Users/tudyg/projet/T-DEV-703-Mobile/front/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///mnt/c/Users/tudyg/projet/T-DEV-703-Mobile/front/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file:///mnt/c/Users/tudyg/projet/T-DEV-703-Mobile/front/node_modules/@unhead/ssr/dist/index.mjs';
import { createHooks } from 'file:///mnt/c/Users/tudyg/projet/T-DEV-703-Mobile/front/node_modules/hookable/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///mnt/c/Users/tudyg/projet/T-DEV-703-Mobile/front/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///mnt/c/Users/tudyg/projet/T-DEV-703-Mobile/front/node_modules/unenv/runtime/fetch/index.mjs';
import { klona } from 'file:///mnt/c/Users/tudyg/projet/T-DEV-703-Mobile/front/node_modules/klona/dist/index.mjs';
import defu, { defuFn } from 'file:///mnt/c/Users/tudyg/projet/T-DEV-703-Mobile/front/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///mnt/c/Users/tudyg/projet/T-DEV-703-Mobile/front/node_modules/scule/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///mnt/c/Users/tudyg/projet/T-DEV-703-Mobile/front/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///mnt/c/Users/tudyg/projet/T-DEV-703-Mobile/front/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///mnt/c/Users/tudyg/projet/T-DEV-703-Mobile/front/node_modules/radix3/dist/index.mjs';
import { getContext } from 'file:///mnt/c/Users/tudyg/projet/T-DEV-703-Mobile/front/node_modules/unctx/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///mnt/c/Users/tudyg/projet/T-DEV-703-Mobile/front/node_modules/consola/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///mnt/c/Users/tudyg/projet/T-DEV-703-Mobile/front/node_modules/errx/dist/index.js';
import { isVNode, unref, version } from 'file:///mnt/c/Users/tudyg/projet/T-DEV-703-Mobile/front/node_modules/vue/index.mjs';
import { hash } from 'file:///mnt/c/Users/tudyg/projet/T-DEV-703-Mobile/front/node_modules/ohash/dist/index.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///mnt/c/Users/tudyg/projet/T-DEV-703-Mobile/front/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///mnt/c/Users/tudyg/projet/T-DEV-703-Mobile/front/node_modules/@unhead/shared/dist/index.mjs';
...
const _9ffvQFngZK = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/mnt/c/Users/tudyg/projet/T-DEV-703-Mobile/front";
...
const _lazy_OrUpYF = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_OrUpYF, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_OrUpYF, lazy: true, middleware: false, method: undefined }
];

const serverAssets = [{"baseName":"server","dir":"/mnt/c/Users/tudyg/projet/T-DEV-703-Mobile/front/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/mnt/c/Users/tudyg/projet/T-DEV-703-Mobile/front","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/mnt/c/Users/tudyg/projet/T-DEV-703-Mobile/front/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/mnt/c/Users/tudyg/projet/T-DEV-703-Mobile/front/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/mnt/c/Users/tudyg/projet/T-DEV-703-Mobile/front/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/mnt/c/Users/tudyg/projet/T-DEV-703-Mobile/front/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const getClientManifest = () => import('file:///mnt/c/Users/tudyg/projet/T-DEV-703-Mobile/front/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///mnt/c/Users/tudyg/projet/T-DEV-703-Mobile/front/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
